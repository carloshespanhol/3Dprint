...
module M(x=0, y=0, z=0){mirror([x, y, z]) children();}
...
module Sq(x =10, y = 0, center = false)
{
   if(y==0)
...
// primitives - 3d
module Cy(r = 10, h = 1, center = false)
{
	cylinder(r = r, h = h, center = center); 
}
module Cu(x = 10, y = 0, z = 10, center = false)
{
  if (y==0)
...
module CyH(r = 10, h = 1, w = 0, center = false)
  cylinder_half(r, h, w, center); 

module CyS(r = 10, h = 1, w1 = 0, w2 = 90, center = false)
  cylinder_segment(r, h, w1, w2, center); 

module Ri(R = 10, r = 5, h = 1, center = false)
  ring(R, r, h, center); 

module RiS(R = 10, r = 5, h = 1, w1 = 0, w2 = 90, center = false)
   ring_segment(R, r, h, w1, w2, center); 

module RiH(r1 = 10, r2, h = 1, w = 0, center = false)
   ring_half(r1, r2, h, w, center); 
module Pie(r = 10, h = 1, w1 = 0, w2 = 90, center = false)
  cylinder_segment(r, h, w1, w2, center);  
module Sp(r = 10)
  sphere(r); 
