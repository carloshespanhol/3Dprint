   ...
   /**/ 
    ...
    difference(){
        union(){            
            ...
            /* pin */
            hull(){
                translate([-x/5,yp+13,0])
                rcube(x/2.5,5, 7.5, 1);

                translate([-x/2,yp+9,0])
                rcube(x,4, 3.7, 1);
            }
        ...
        // servo pin
        translate([0,0,-.1])
        polyhole(d=sp+tf,h=5);
        
        hull(){
            translate([0,0,-.1])
            polyhole(d=sp+tf,h=1.1);
        ...
        // switch
        translate([-13.1/2,yp+2.01,1.1])
        cube([13.1,6.7,8]);
        
        translate([0,yp+13.5,4])
        rotate([90,0,0])
        {
            Mscrew(2,2.75);
            translate([0,0,-8])
