...
text_type="raised";//[embossed,raised]
...
{ 
    ...
    testradius=(z-.2)/2;
    translate([wall+r_hole+r_hole*10, h-wall-r_hole*.5, testradius+.2])
                rotate([90,0,0])
...
{            
    ...
    stepareadistance=(test_patterns=="enabled"?1.8:1);
