...
difference(){
    translate([-s/2,10,-s/2])
    cube([s,20,s]);
    
    translate([0,12,0])
    rotate([-90,0,0])
    cylinder(d=8.2, h=25, $fn=32);
}
...
gopro_bar_screw_reversed=true; // [true,false]
